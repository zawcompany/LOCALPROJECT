 ...
 * @author ASUS
 */
public class PROV_KAL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Select your destination province in Kalimantan Island");
        jTextArea1.setWrapStyleWord(true);
        jTextArea1.setBorder(null);
        jPanel1.add(jTextArea1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, -1, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_COMPONENT/KALIMANTAN.png"))); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 249, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_COMPONENT/BATIK_SUM.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 190, 40));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_COMPONENT/BATIK_SUM - Copy.png"))); // NOI18N
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, 210, 40));
        ...
        jButton6.setText("North Kalimantan");
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 570, 130, -1));
        ...
        jButton7.setText("East Kalimantan");
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 460, 130, -1));
        ...
        jButton10.setText("South Kalimantan");
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 530, 130, -1));
        ...
        jButton11.setText("West Kalimantan");
        ...
        jPanel1.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 130, -1));
        ...
        jButton12.setText("Central Kalimantan");
        ...
        jPanel1.add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 500, 140, -1));

        jTextArea2.setBackground(new java.awt.Color(255, 248, 240));
        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Cambria", 2, 14)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("Kalimantan, the wild frontier of Indonesia, is a haven for nature\nenthusiasts. Home to the mystical rainforests of Tanjung Puting\nand its iconic orangutans, the mighty Mahakam River, and the \n    cultural richness of Dayak tribes, Kalimantan promises an \n                                     adventure like no other.");
        jTextArea2.setWrapStyleWord(true);
        jTextArea2.setBorder(null);
        jPanel1.add(jTextArea2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, -1, -1));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_COMPONENT/BATIKKAL2.png"))); // NOI18N
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 470, -1, 190));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI_COMPONENT/BATIKKAL.png"))); // NOI18N
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        Detail_KaltimC kekaltim = new Detail_KaltimC();
        kekaltim.setVisible(true);
        this.dispose();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        Detail_WestKal keWestKal = new Detail_WestKal(); // Buat instance frame HOME
        keWestKal.setVisible(true); // Tampilkan halaman HOME
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PROV_KAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
